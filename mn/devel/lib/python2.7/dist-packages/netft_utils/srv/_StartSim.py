...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2i2d.pack(_x.simDim, _x.simType, _x.simSlope, _x.maxForce))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.simDim, _x.simType, _x.simSlope, _x.maxForce,) = _struct_2i2d.unpack(str[start:end])
      return self
