...
if("TRUE" STREQUAL "TRUE")
  set(robotiq_modbus_rtu_SOURCE_PREFIX /home/baxter/mn/src/robotiq/robotiq_modbus_rtu)
  set(robotiq_modbus_rtu_DEVEL_PREFIX /home/baxter/mn/devel)
  ...
  set(robotiq_modbus_rtu_INSTALL_PREFIX /home/baxter/mn/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jean-Philippe Roberge <ros@robotiq.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/baxter/mn/src/robotiq/robotiq_modbus_rtu/${idir}'.  Ask the maintainer 'Jean-Philippe Roberge <ros@robotiq.com>' to fix it.")
    endif()
