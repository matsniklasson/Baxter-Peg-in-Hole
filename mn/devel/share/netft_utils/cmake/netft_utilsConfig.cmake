...
if("TRUE" STREQUAL "TRUE")
  set(netft_utils_SOURCE_PREFIX /home/baxter/mn/src/netft_utils)
  set(netft_utils_DEVEL_PREFIX /home/baxter/mn/devel)
  ...
  set(netft_utils_INSTALL_PREFIX /home/baxter/mn/install)
...
if(NOT "/home/baxter/mn/devel/include;/home/baxter/mn/src/netft_utils/include " STREQUAL " ")
  set(netft_utils_INCLUDE_DIRS "")
  set(_include_dirs "/home/baxter/mn/devel/include;/home/baxter/mn/src/netft_utils/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'netft_utils' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Andy Zelenak <andyz@utexas.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'netft_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/baxter/mn/src/netft_utils/${idir}'.  Ask the maintainer 'Andy Zelenak <andyz@utexas.edu>' to fix it.")
    endif()
...
set(netft_utils_EXPORTED_TARGETS "netft_utils_generate_messages_cpp;netft_utils_generate_messages_lisp;netft_utils_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${netft_utils_dep}_FOUND)
      find_package(${netft_utils_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${netft_utils_dep} REQUIRED ${depend_list})
  endif()
