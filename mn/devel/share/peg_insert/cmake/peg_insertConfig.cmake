...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'peg_insert' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/baxter/mn/src/peg_insert/${idir}'.  Ask the maintainer 'Mats Niklasson <19134299@student.curtin.edu.au>' to fix it.")
    endif()
