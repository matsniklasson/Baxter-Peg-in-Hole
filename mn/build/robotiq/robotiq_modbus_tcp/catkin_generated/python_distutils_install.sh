...
echo_and_run cd "/home/baxter/mn/src/robotiq/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/baxter/mn/src/robotiq/robotiq_modbus_tcp/setup.py" \
    build --build-base "/home/baxter/mn/build/robotiq/robotiq_modbus_tcp" \
    install \
    $DESTDIR_ARG \
