...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bhand_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/baxter/mn/install/${idir}'.  Ask the maintainer 'Román Navarro <rnavarro@robotnik.es>, Jorge Ariño <jarino@robotnik.es>' to fix it.")
    endif()
